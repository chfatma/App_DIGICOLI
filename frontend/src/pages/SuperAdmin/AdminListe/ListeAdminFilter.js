...
import './ListeAdminFilter.css';

const SuperAdminListe = ({ selectedGouvernement, setSelectedGouvernement, setSelectedDate }) => {
  ...
  return (
    <div className="superAdmin-list-container-custom">
...
export default SuperAdminListe;
