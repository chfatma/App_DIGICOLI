...
class DoughnutChart22 extends Component {
	constructor() {
		super();
		this.options = {};
	...
	render() {	
		this.options = {
			"New vs Returning Visitors": [{
				...
				type: "doughnut",
				dataPoints: [
					{ y: 522460, name: "New Visitors", color: "#193A69" },
					{ y: 307040, name: "Returning Visitors", color: "#F26622" }
				]
			}],
			"New Visitors": [{
				color: "#E7823A",
...
export default DoughnutChart22;   